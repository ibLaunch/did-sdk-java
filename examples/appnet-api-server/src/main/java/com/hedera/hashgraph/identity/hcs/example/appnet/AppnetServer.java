...
public class AppnetServer {
  ...
  public static void main(final String[] args) {
    log.info("Starting appnet API server...ibL-Health");
  ...
  private void initHederaIdentityNetwork() throws HederaNetworkException, HederaStatusException {
    ...
    final AccountId operatorId = AccountId.fromString("0.0.49005");
    final Ed25519PrivateKey operatorKey = Ed25519PrivateKey
            .fromString("302e020100300506032b657004220420136178e23f355cb7171f89781fb695f1152bfaec985335300aebde078087b5e8");
    ...
    final String mirrorNodeAddress = Objects.requireNonNull("hcs.testnet.mirrornode.hedera.com:5600");
